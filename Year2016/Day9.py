...
def part1(input_str):
    ...
    while i < len(string):
        ...
        if c == "(":
            ...
            marker_length, marker_count = (int(marker.split("x")[0]), int(marker.split("x")[1]))

            repeat_seq = string[i: i + marker_length]
            result += repeat_seq * marker_count
            i += marker_length
        else:
            result += string[i]
            i += 1
...
def decompress(input_str):
    ...
    while i < len(input_str):
        ...
        if c == "(":
            ...
            repeat_seq = input_str[i: i +marker_length]
            decompressed_len += decompress(repeat_seq) * marker_count
            i += len(repeat_seq)
        else:
            decompressed_len += 1
            i += 1
